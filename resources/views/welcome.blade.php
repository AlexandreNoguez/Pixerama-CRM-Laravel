    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img src="/logo.png" class="h-16 w-auto bg-gray-100 dark:bg-gray-900 rounded-full" />
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="#"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Introdução</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                O Projeto de Leads foi desenvolvido como uma proposta de teste técnico para
                                Desenvolvedor de Software - Fullstack para gerenciamento de leads em uma organização.
                            </p>
                        </div>
                    ...
                    <a href="#"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Visão Geral do Projeto
                            </h2>

                            <ul
                                class="list-disc list-inside mb-6 mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                <li class="text-gray-800">Interface Intuitiva.</li>
                                <li class="text-gray-800">Personalização Flexível.</li>
                                <li class="text-gray-800">Análises Avançadas.</li>
                                <li class="text-gray-800">Colaboração Integrada.</li>
                            </ul>
                        </div>
