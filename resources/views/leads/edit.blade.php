<x-app-layout>
    ...
    <form method="POST" action="{{ route('leads.update', $lead->id) }}" class="max-w-80 mx-auto mt-4">
        @csrf
        @method('PUT')
        <!-- Título -->
        <div>
            <x-input-label for="leadTitle" :value="__('Título')" />
            <x-text-input id="leadTitle" class="block mt-1 w-full" type="text" name="leadTitle" :value="$lead->leadTitle"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="leadName" class="block mt-1 w-full" type="text" name="leadName" :value="$lead->leadName"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="companyName" class="block mt-1 w-full" type="text" name="companyName"
                autocomplete="companyName" :value="$lead->companyName" />
        ...
        <div class="mt-4" >
            ...
            <div class="mt-4">
                ...
                <input id="price" class="block mt-1 w-full" type="text" name="price"
                    data-mask="000.000.000.000.000,00" autocomplete="price" placeholder="Apenas números" value="{{$lead->price}}" />
            ...
            <div class="mt-4">
                ...
                <textarea id="description" class="block mt-1 w-full" type="text" name="description"
                    autocomplete="description">{{$lead->description}}</textarea>
